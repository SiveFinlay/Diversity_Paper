...
%-----------------------------------------
%Current title page 
%NB PeerJ don't want a title page: just the author details but I haven't figured out how to do that without losing the formatting of the rest of the manuscript
%I may need to get rid of the lists of tables and figures at the end: they want titles and legends to be on the same page as the figure/table
%----------------------------------------
...
%****************************************************
%Abstract
%Peer J wants the abstract as a separate document
...
%This is the abstract from my thesis
	...
	%Morphological diversity is often studied qualitatively. However, to truly understand the evolution of diversity, it is important to take a quantitative approach instead of relying on subjective, qualitative assessments. Here, we present a quantitative analysis of morphological diversity in a Family of small mammals, the tenrecs (Afrosoricida, Tenrecidae). 
	%Tenrecs are often cited as an example of an exceptionally morphologically diverse group. However, this assumption has not been tested quantitatively. We use geometric morphometric analyses of skull shape to test whether tenrecs are more morphologically diverse than their closest relatives, the golden moles (Afrosoricida, Chrysochloridae). Tenrecs occupy a wider range of ecological niches than golden moles so we predicted that they would be more morphologically diverse. 
	%Contrary to our expectations, We found that tenrec skulls are only more morphologically diverse than golden moles when measured in lateral view. Furthermore, similarities among the species-rich \textit{Microgale} tenrec Genus appear to mask higher morphological diversity in the rest of the Family. These results reveal new insights into the morphological diversity of tenrecs and highlight the importance of using quantitative methods to test qualitative assumptions about patterns of morphological diversity. 
...
\section{Introduction}
	...
	%Might need more to finish off the introduction?
%************************************
