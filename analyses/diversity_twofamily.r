#27/01/15
  ...
  #Morphological disparity calculations
  ...
  #Note that this script can be used for each of the three analyses (skulls in dorsal/ventral/lateral views)
  #There is also an option to use a reduced data set: subsampling the tenrecs to include just five Microgale species
...
#************************************
#Option to select a subset of tenrecs: five of the Microgale species
#************************************
...
#Note that there is a separate script to plot all PCA results together
...
##############################################
#Output
#Uncomment the appropriate lines depending on which analysis is run at the start

setwd("C:/Users/sfinlay/Desktop/Diversity/output/")      
      
#Skdors: full data
  # PC.man
    #capture.output(PC.man, file= "skdors/skdors_manova.res.txt")
  # mean.se
    #capture.output(mean.se, file= "skdors/skdors_mean+se.txt")    
  # t test results
    #capture.output(comp.cent, file= "skdors/skdors_ttest.txt") 
  #perm.res.summary
    #capture.output(perm.res.summary, file= "skdors/skdors_perm.res.summary.txt") 
      
#Skdors: subset of tenrecs  (five Microgale species)
  # PC.man
    #capture.output(PC.man, file= "skdors/skdors_subtenrec_manova.res.txt")
  # mean.se
    #capture.output(mean.se, file= "skdors/skdors_subtenrec_mean+se.txt")    
  # t test results
    #capture.output(comp.cent, file= "skdors/skdors_subtenrec_ttest.txt") 
  #perm.res.summary
    #capture.output(perm.res.summary, file= "skdors/skdors_subtenrec_perm.res.summary.txt") 
#--------------------------------------------------------------------------------------------
#Skvent: full data
  # PC.man
    #capture.output(PC.man, file= "skvent/skvent_manova.res.txt")
  # mean.se
    #capture.output(mean.se, file= "skvent/skvent_mean+se.txt")    
  # t test results
    #capture.output(comp.cent, file= "skvent/skvent_ttest.txt") 
  #perm.res.summary
    #capture.output(perm.res.summary, file= "skvent/skvent_perm.res.summary.txt") 
      
#Skvent: subset of tenrecs
  # PC.man
    #capture.output(PC.man, file= "skvent/skvent_subtenrec_manova.res.txt")
  # mean.se
    #capture.output(mean.se, file= "skvent/skvent_subtenrec_mean+se.txt")    
  # t test results
    #capture.output(comp.cent, file= "skvent/skvent_subtenrec_ttest.txt") 
  #perm.res.summary
    #capture.output(perm.res.summary, file= "skvent/skvent_subtenrec_perm.res.summary.txt") 
#--------------------------------------------------------------------------------------------
#Sklat: full data
  # PC.man
    #capture.output(PC.man, file= "sklat/sklat_manova.res.txt")
  # mean.se
    #capture.output(mean.se, file= "sklat/sklat_mean+se.txt")    
  # t test results
    #capture.output(comp.cent, file= "sklat/sklat_ttest.txt") 
  #perm.res.summary
    #capture.output(perm.res.summary, file= "sklat/sklat_perm.res.summary.txt") 
      
#Sklat: subset of tenrecs
  # PC.man
    #capture.output(PC.man, file= "sklat/sklat_subtenrec_manova.res.txt")
  # mean.se
    #capture.output(mean.se, file= "sklat/sklat_subtenrec_mean+se.txt")    
  # t test results
    #capture.output(comp.cent, file= "sklat/sklat_subtenrec_ttest.txt") 
  #perm.res.summary
    #capture.output(perm.res.summary, file= "sklat/sklat_subtenrec_perm.res.summary.txt") 
###########################################################
